...
mount -o defaults,autodefrag,discard,noatime,compress=zstd:5,space_cache=v2,nodatacow,subvol=@/var/spool /dev/mapper/root /mnt/var/spool
mount -o defaults,autodefrag,discard,noatime,compress=zstd:5,space_cache=v2,nodatacow,subvol=@/var/tmp /dev/mapper/root /mnt/var/tmp
mount -o defaults,autodefrag,discard,noatime,compress=zstd:5,space_cache=v2,nodatacow,subvol=@/var/lib/libvirt/images /dev/mapper/root /mnt/var/lib/libvirt/images
...
mount -o defaults,autodefrag,discard,noatime,compress=zstd:5,space_cache=v2,nodatacow,subvol=@/var/lib/mariadb /dev/mapper/root /mnt/var/lib/mariadb
