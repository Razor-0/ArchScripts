...
cryptsetup -q open /dev/sda2 esp
printf "123" | cryptsetup -q open /dev/sda2 esp
...
cryptsetup -q open /dev/vgroot/btrfs root
printf "123" | cryptsetup -q open /dev/vgroot/btrfs
