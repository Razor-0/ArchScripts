...
printf "PASSWORD" | cryptsetup -q luksFormat --type luks1 --use-urandom -h sha1 -i 1000 /dev/sda2
printf "PASSWORD" | cryptsetup luksOpen /dev/sda2 esp

printf "PASSWORD" | cryptsetup -q luksFormat --type luks2 --use-urandom -h sha512 -i 1000 /dev/vgroot/btrfs
printf "PASSWORD" | cryptsetup luksOpen /dev/vgroot/btrfs root
