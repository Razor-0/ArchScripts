...
pacman -S --noconfirm grub efibootmgr os-prober btrfs-progs ntfs-3g dosfstools linux-zen-headers base-devel xdg-user-dirs alsa-utils xdg-utils networkmanager network-manager-applet wpa_supplicant bluez bluez-utils tlp acpi acpi_call-dkms acpid nfs-utils lvm2 linux-lts linux-lts-headers rsync snapper doas
