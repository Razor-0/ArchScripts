...
pacman -S --noconfirm grub efibootmgr os-prober btrfs-progs ntfs-3g mtools dosfstools linux-zen-headers base-devel xdg-user-dirs alsa-utils xdg-utils networkmanager wpa_supplicant bluez bluez-utils
