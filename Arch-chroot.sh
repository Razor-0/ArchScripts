...
pacman -S --noconfirm grub efibootmgr os-prober btrfs-progs ntfs-3g dosfstools mtools linux-zen-headers base-devel xdg-user-dirs alsa-utils xdg-utils neofetch networkmanager network-manager-applet wpa_supplicant bluez bluez-utils tlp acpi acpi_call-dkms acpid nfs-utils rsync snapper lvm2 linux-lts linux-lts-headers
